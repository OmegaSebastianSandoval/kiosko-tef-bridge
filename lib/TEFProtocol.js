...
export class TEFProtocol {
  ...
  /**
   * Calcula la longitud de mensaje en formato ASCII de 4 caracteres
   * Ejemplo: 17 bytes -> "0017" -> Buffer con bytes ASCII 30 30 31 37
   */
  static buildLength(messageLength) {
    const lengthStr = messageLength.toString(10).padStart(4, "0");
    return Buffer.from(lengthStr, "ascii");
  }
